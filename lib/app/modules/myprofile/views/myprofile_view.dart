                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      InkWell(
                        onTap: () => Get.toNamed(Routes.SAVED_TRANSPORTATIONS),
                        child: const Profilebtns(
                          title: "وسائل النقل المحفوظة",
                          icon: Icon(
                      ...
                      InkWell(
                        onTap: () => Get.toNamed(Routes.MY_PAYMENTS),
                        child: const Profilebtns(
                          title: "عمليات الدفع",
                          icon: Icon(
                            IconlyLight.wallet,
                      ...
                      GestureDetector(
                        onTap: () {
                          Get.defaultDialog(
                            ...
                            radius: 12,
                            onConfirm: () {
                              Get.offAllNamed(Routes.LOGIN); // Close the dialog
                            },
                            onCancel: () {
